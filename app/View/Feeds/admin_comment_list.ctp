    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			<li><i class="fa fa-home"></i> <?php echo $this->Html->getCrumbs(' > ', array(
				'text' => 'Home',
				'url' => array('controller' => 'feeds', 'action' => 'commentList', 'admin'=>true),
				'escape' => false
                )); ?> 
	        </li>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                     <div class="input-append span12">
						<input type="text" name="data[q]" class="search-query myInput" placeholder="Type to search">
				    </div> 
                </div>
            </div>
        </div>
...
$(function(){
	...
	function doneTyping (){
		...
		$.ajax({
					type: "GET",
					url: root +'admin/feeds/commentList/text:'+ text,
