 ...
 <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            ?>
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <?php
                                     echo $this->form->input('cat_id',array('label'=>false,'type'=>'select','options'=>$category,'empty'=>'Select category','multiple' => 'multiple', 'class'=>'select2 form-control','required' => true));
                                      ?>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <?php
                                     echo $this->form->input('Shop.sub_cat',array('label'=>false,'type'=>'select','options'=>$subcategory,'empty'=>'Select subcategory','multiple' => 'multiple', 'class'=>'select2 form-control','required' => true));
                                      ?>
                                  </div>
                              </div>
                        ...
                        <?php
                        echo $this->form->input('Shop.user_id',array('label'=>false,'type'=>'select','options'=>$provider,'empty'=>'Select provider','class'=>'select2 form-control','required' => true));
                        ?>
                        </div>
                        </div> 
                     <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                              ...
                                              <!--<input type="checkbox" name="promotion_type_old" id="gender" checked />-->
                                              <label class="switch">
                                              <input type="checkbox" name="data[Shop][chat]" id="chat" checked />
                                              <span class="slider round1"></span>
                                              </label>
                                              </div>
                                              <?php
                                           ...
                                           <div class="col-md-2">
                                            <div class="form-group">
                                              ...
                                              <!--<input type="checkbox" name="promotion_type_old" id="gender" checked />-->
                                              <label class="switch">
                                              <input type="checkbox" name="data[Shop][online]" id="online" checked />
                                              <span class="slider round1"></span>
                                              </label>
                                              </div>
                                              <?php
